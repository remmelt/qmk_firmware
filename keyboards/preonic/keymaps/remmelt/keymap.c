...
#define WIN_MAX LCA(KC_ENT) // Grow window to max size in Magnet
#define FND_USG LCA(KC_ENT) // Find usages in IntelliJ
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Lower| 1Pwd | Alt  | GUI  | Raise|    Space    |Enter | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
 ...
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      |   [  |   ]  |   {  |   }  |FndUsg|  No  |  No  |  No  |  F11 |  F12 | Del  |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |(EscC)|      |      |      |      |      | Left | Down |  Up  |Right |      |      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |(Shft)|      |      |      |Paste |      |      |      |      |      |      |   \  |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
...
[_RAISE] = LAYOUT_preonic_grid( \
  ...
  XXXXXXX, KC_LBRC, KC_RBRC, KC_LCBR, KC_RCBR, FND_USG, XXXXXXX, XXXXXXX, XXXXXXX, KC_F11,  KC_F12,  KC_DEL,  \
  _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, XXXXXXX, RESET,   \
